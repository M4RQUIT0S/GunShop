  ...
  var LINES = [
    {
      ...
      items: [
        ...
        { brand: 'CZ', ref: '457 Varmint', photo: 'img/product/cz-457-varmint.webp', kind: 'Rifle del 22', licence: 'Uso civil', licence: 'Uso civil',
          cals: ['.22 LR'],
    ...
    },
    {
      ...
      items: [
        ...
        { brand: 'AyA', ref: 'Aguila', photo: 'img/product/aya-aguila.webp', kind: 'Paralela · Eibar',
          cals: ['cal. 12/70', 'cal. 20/70'],
          spec: ['cañón 710 mm', '3,0 kg', 'grabado a mano'], usd: 8300 },
        { brand: 'Grulla Armas', ref: 'Consejo', photo: 'img/product/grulla-armas-consejo.webp', kind: 'Paralela · Eibar',
          cals: ['cal. 12/70', 'cal. 20/70'],
    ...
    },
    {
      ...
      items: [
        ...
        { brand: 'RIO', ref: 'Star 32 cal. 12/70', photo: 'img/product/rio-star-32-cal-12-70.webp', kind: 'Cartuchería de caza',
          spec: ['plomo 32 g del 6', 'caja de 25'], usd: 22 },
        { brand: 'SAGA', ref: 'Perdiz 34 cal. 12/70', photo: 'img/product/saga-perdiz-34-cal-12-70.webp', kind: 'Cartuchería de caza',
    ...
    },
    {
      ...
      items: [
        ...
        { brand: 'Vanguard', ref: 'Pioneer 46', photo: 'img/product/vanguard-pioneer-46.webp', kind: 'Funda blanda',
        ...
        { brand: 'Arregui', ref: 'Rifle 180020', photo: 'img/product/arregui-rifle-180020.webp', kind: 'Armero homologado',
          spec: ['5 plazas', 'grado I', 'anclaje a muro'], usd: 1130 },
        { brand: 'Ferrimax', ref: 'Alfa 5', photo: 'img/product/ferrimax-alfa-5.webp', kind: 'Armero homologado',
