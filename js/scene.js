...
(function (global) {
  ...
  function rifle() {
    var stock = [
      ...
      [0.42, 0.30], [0.55, 0.22], [1.32, 0.20], [1.30, -0.02],
      [0.60, -0.24], [0.05, -0.28], [-0.06, -0.30], [-0.06, -0.66],
      [-0.46, -0.66], [-0.46, -0.30], [-0.60, -0.30], [-0.72, -0.40],
      [-0.92, -0.72], [-1.18, -0.66], [-1.34, -0.42], [-1.60, -0.34],
      [-2.10, -0.28]
    ];
    return merge([
      extrude(stock, 0.30),
      tube(0.55, 2.35, 0.085, 0.078, 14, 0.06, 0),
      tube(-0.78, 0.06, 0.125, 0.125, 14, 0.54, 0),
      tube(0.06, 0.34, 0.125, 0.175, 14, 0.54, 0),
      tube(-0.62, -0.54, 0.16, 0.16, 12, 0.54, 0),
      tube(-0.06, 0.02, 0.16, 0.16, 12, 0.54, 0)
    ]);
  }

  function shotgun() {
    var stock = [
      [-2.20, 0.30], [-1.70, 0.42], [-1.24, 0.38], [-0.96, 0.30],
      [-0.10, 0.28], [-0.10, 0.02], [0.86, 0.04], [0.88, -0.20],
      [0.10, -0.30], [-0.34, -0.32], [-0.52, -0.30], [-0.66, -0.42],
      [-0.94, -0.74], [-1.22, -0.66], [-1.40, -0.42], [-1.68, -0.34],
      [-2.20, -0.28]
    ];
    return merge([
      extrude(stock, 0.28),
      tube(-0.14, 2.30, 0.085, 0.080, 14, 0.20, 0),
