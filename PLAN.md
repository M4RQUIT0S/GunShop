...
Sus fases 1 y 2 —chips que envuelven y filtro de calibre— las cubre la fase 4
de aquí, que las portó sobre Supabase. Lo que seguía vivo se recoge abajo; el
cuaderno original está en la rama `main-antes-del-merge`.

### Subcategorías nuevas de producto — BLOQUEADO POR FOTOGRAFÍA

Faltan por dar de alta: revólver, bípode, monturas, linterna, protección
auditiva y ocular, caja de munición, cinturón, colimador y dies. **Sin armas
usadas** (pedido expreso: una usada es unidad única con número de serie).

No es la taxonomía: es que **no hay foto honesta**. Se buscó en Commons dos
veces —por texto libre y por categoría, filtrando por licencia redistribuible,
ancho mínimo y apaisada— y se **miraron** las candidatas. Las tres mejores
fallaron:
...
1. Fotografiar en el taller. Resuelve a la vez la deuda de
   `public/img/product/`, que tampoco está aclarada para redistribuir.
2. Pedir permiso al distribuidor y anotarlo en su `CREDITS.md`.
...
- **Fulminantes y pólvora.** Componente explosivo; no está claro que sea venta
  libre en la ANMaC y equivocarse es entregarlo sin pedir credencial. Una
  etiqueta desconocida cae en «Venta libre», que es vender sin pedir el papel.
